...
$sql = "SELECT \"firstName\", \"lastName\", email, reg_date FROM users WHERE \"accountType\" = 'seller'";
...
<head>
    ...
    <title>قطعتي - قسم البائعين</title>
    ...
    <section class="page-sidebar">
        ...
        <nav class="main-nav">
            <ul>
                ...
                <li class="nav-item active"><a href="admin_admins.php"><i class="fas fa-user-shield"></i> قسم البائعين</a></li>
                    ...
                    <section class="generalAdmin-dashboard users_admin ">
                        <div class="container_usersadmin">
                            <div class="section_title text-center">
                                ...
                                <p>استعرض قائمة البائعين المسجلين في الموقع وتعرّف عليهم.</p>
                            </div>
                            <form class="search-bar-container" method="GET">
                                <input type="text" class="search-bar" name="search" placeholder="ابحث عن اسم البائع..." value="<?= htmlspecialchars($searchQuery) ?>">
